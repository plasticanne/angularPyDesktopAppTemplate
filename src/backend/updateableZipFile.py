...
class UpdateableZipFile(ZipFile):
    ...
    def writestr(self, zinfo_or_arcname, data, compress_type=None):
        ...
        # print('writestr',self._allow_updates and name in self.namelist())
        # print('writestr',self._allow_updates )
        # print('writestr',name in self.namelist())
        # print('writestr',name )
        # print('writestr',self.namelist() )
